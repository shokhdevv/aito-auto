...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed py-4 w-full lg:py-7 duration-300 ${isScrollingDown ? "-top-20" : "top-0"} ${navScroll ? 'bg-black ' : 'bg-[#1515150F] backdrop-blur-2xl '}`}>
      <div className="container flex items-center justify-between">
        ...
        <div className='flex items-center gap-3 xl:gap-6 lg:w-[40%] justify-end'>
          <ul className='max-lg:hidden text-white flex items-center gap-3 text-sm  xl:text-base xl:gap-6'>
            {
          ...
          <div>
            <CgMenuGridO className='text-white text-2xl lg:hidden' onClick={handleOpenNav} />
          </div>
